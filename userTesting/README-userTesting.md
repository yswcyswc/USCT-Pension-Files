...
Put everything for user testing inside this folder: userTesting

Do not put these user-testing files in `dataset`.
...
Copy one of the existing upload scripts, such as: UT3_upload.py


Then update the UT number in these places:

- `SUBJECT_SET_NAME = "UT5"`
- `IMAGE_PATH = BASE_DIR / "UT5.png"`
- `TRANSCRIPT_PATH = BASE_DIR / "UT5.txt"`
...
```powershell
python userTesting\UT5_upload.py
```
