...
SUBJECT_SET_NAME = os.getenv("SUBJECT_SET_NAME", "UT4")

REPO_ROOT = Path(__file__).resolve().parents[2]
ASSET_DIR = REPO_ROOT / "dataset/userTesting"
IMAGE_PATH = ASSET_DIR / "images/UT4.png"
TRANSCRIPT_PATH = ASSET_DIR / "transcripts/UT4.txt"
...
subject.metadata["pdf"] = "UT4"
subject.metadata["pdf_file"] = "UT4.png"
subject.metadata["transcription_id"] = "UT4"
