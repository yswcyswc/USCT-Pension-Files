...
SUBJECT_SET_NAME = os.getenv("SUBJECT_SET_NAME", "UT3")

REPO_ROOT = Path(__file__).resolve().parents[2]
ASSET_DIR = REPO_ROOT / "dataset/userTesting"
IMAGE_PATH = ASSET_DIR / "images/UT3.png"
TRANSCRIPT_PATH = ASSET_DIR / "transcripts/UT3.txt"
...
subject.metadata["pdf"] = "UT3"
subject.metadata["pdf_file"] = "UT3.png"
subject.metadata["transcription_id"] = "UT3"
