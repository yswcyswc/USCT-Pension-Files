...
SUBJECT_SET_NAME = os.getenv("SUBJECT_SET_NAME", "UT6")

REPO_ROOT = Path(__file__).resolve().parents[2]
ASSET_DIR = REPO_ROOT / "dataset/userTesting"
IMAGE_PATH = ASSET_DIR / "images/UT6.png"
TRANSCRIPT_PATH = ASSET_DIR / "transcripts/UT6.txt"
...
subject.metadata["pdf"] = "UT6"
subject.metadata["pdf_file"] = "UT6.png"
subject.metadata["transcription_id"] = "UT6"
