...
SUBJECT_SET_NAME = os.getenv("SUBJECT_SET_NAME", "UT2")

REPO_ROOT = Path(__file__).resolve().parents[2]
ASSET_DIR = REPO_ROOT / "dataset/userTesting"
IMAGE_PATH = ASSET_DIR / "images/UT2.png"
TRANSCRIPT_PATH = ASSET_DIR / "transcripts/UT2.txt"
...
subject.metadata["pdf"] = "UT2"
subject.metadata["pdf_file"] = "UT2.png"
subject.metadata["transcription_id"] = "UT2"
