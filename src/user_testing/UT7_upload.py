...
SUBJECT_SET_NAME = os.getenv("SUBJECT_SET_NAME", "UT7")

REPO_ROOT = Path(__file__).resolve().parents[2]
ASSET_DIR = REPO_ROOT / "dataset/userTesting"
IMAGE_PATH = ASSET_DIR / "images/UT7.png"
TRANSCRIPT_PATH = ASSET_DIR / "transcripts/UT7.txt"
...
subject.metadata["pdf"] = "UT7"
subject.metadata["pdf_file"] = "UT7.png"
subject.metadata["transcription_id"] = "UT7"
